...
LUCIS_VEC_IMPL(uint8_t,   u1)   // 1-bit unsigned, stored in 1 byte by LLVM
LUCIS_VEC_IMPL(uint8_t,   i1)   // 1-bit signed, stored in 1 byte by LLVM
...
LUCIS_VEC_TOSTRING_IMPL(uint16_t, u16,  "%u")LUCIS_VEC_TOSTRING_IMPL(uint32_t, u32, "%u")
LUCIS_VEC_TOSTRING_IMPL(uint64_t, u64, "%llu")
LUCIS_VEC_TOSTRING_IMPL(uint8_t,  u1,  "%u")
LUCIS_VEC_TOSTRING_IMPL(uint8_t,  i1,  "%d")
